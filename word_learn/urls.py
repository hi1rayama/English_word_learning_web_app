...
urlpatterns = [
    ...
    path('user_home/learning_home/',views.LearningHome,name="LearningHome"),
    path('user_home/learning_home/learning/<str:value>/',views.Learning,name="Learning"),
    path('user_home/learning_home/result',views.Result,name="Result"),
